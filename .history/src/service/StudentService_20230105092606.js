...
class StudentService {
    ...
    static create(student) {
        let connect = connection.getConnection();
        return new Promise((resolve, reject) => {
            connect.query(`INSERT INTO studentmanager.students(name, class, scoreTheory, evaluate, scorePractice, ) VALUES ('${student.name}', ${+student.age}, '${student.address}', '${student.image}')`, (err, data) => {
                 if (err) {
                     reject(err);
                 }
                 else {
