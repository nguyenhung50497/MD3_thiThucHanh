...
class StudentService {
    ...
    static create(student) {
        let connect = connection.getConnection();
        return new Promise((resolve, reject) => {
            connect.query(`INSERT INTO studentmanager.students(name, class, scoreTheory, evaluate, scorePractice, description) VALUES ('${student.name}', '${+student.class}', ${student.scoreTheory}, '${student.evaluate}', '${student.evaluate}')`, (err, data) => {
                 if (err) {
                     reject(err);
                 }
                 else {
